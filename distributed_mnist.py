...
flags = tf.app.flags
IMAGE_PIXELS = 28
# Define the default parameters and file path
...
# configure jobs & tasks
flags.DEFINE_string('job_name', None, 'job name: worker or ps')
flags.DEFINE_integer('task_index', None, 'Index of task within the job')

# configure training mode
flags.DEFINE_integer("issync", None, "1 for synchronous training; 2 for asynchronous training")
